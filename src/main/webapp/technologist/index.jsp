<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    List<User> techniciansList = UserController.getAllTechnicians();
    %>
<!DOCTYPE html>
<html>
  <head>
              ...
              <div class="row">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <a href="create.jsp" class="btn btn-primary m-3">
                      <span class="tf-icons bx bx-pie-chart-alt"></span>&nbsp; Add Technologist
                  </a>
                </div>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody>
                      <%
                      for (User technologist : techniciansList) {
                      %>
                      <tr>
                        <td><%=technologist.getEmail()%></td>
                        <td><%=technologist.getf_name()%></td>
                        <td><%=technologist.getl_name()%></td>
                        <td><%=technologist.gettelephone()%></td>
                        <td><%=technologist.getNic()%></td>
                        <td><%=technologist.getDob()%></td>
                        <td><a
                          href="create.jsp?email-address=<%=technologist.getEmail()%>">EDIT</a></td>
                      </tr>
                      <%
                      }
                      %>
